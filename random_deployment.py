...
# parser.add_argument('--json-file', type=str, default='train_K10_N50_M4_shadow10_episode1-5000_travel50000_vmax2_5',
...
# json_file = "test_K5_N10_M2_shadow10_episode5-1000_travel0_fd5"
# json_file = "test_K5_N20_M4_shadow10_episode5-1000_travel0_fd5"
# json_file = "test_K10_N20_M1_shadow10_episode5-1000_travel0_fd5"
# json_file = "test_K10_N20_M2_shadow10_episode5-1000_travel0_fd5"
# json_file = "test_K10_N20_M4_shadow10_episode5-1000_travel0_fd5"
...
# json_file = "test_K5_N10_M2_shadow10_episode5-1000_travel0_fd15"
# json_file = "test_K5_N20_M4_shadow10_episode5-1000_travel0_fd15"
# json_file = "test_K10_N20_M1_shadow10_episode5-1000_travel0_fd15"
# json_file = "test_K10_N20_M2_shadow10_episode5-1000_travel0_fd15"
# json_file = "test_K10_N20_M4_shadow10_episode5-1000_travel0_fd15"
...
# json_file = "train_K5_N20_M4_shadow10_episode1-25000_travel0_fd15"
...
# json_file = "train_K10_N50_M10_shadow10_episode1-25000_travel0_fd5"
# json_file = "train_K10_N50_M10_shadow10_episode1-25000_travel0_fd15"
...
#     parser = argparse.ArgumentParser(description='give test scenarios.')
#     parser.add_argument('--json-file', type=str, default='train_K5_N10_M1_shadow10_episode2-5000_travel50000_vmax2_5',
#                        help='json file for the deployment')
#     parser.add_argument('--num-sim', type=int, default=0,
#                        help='If set to -1, it uses num_simulations of the json file. If set to positive, it runs one simulation with the given id.')
