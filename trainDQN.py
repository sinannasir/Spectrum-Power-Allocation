...
#                     help='json file for the deployment')
# parser.add_argument('--json-file', type=str, default='train_K5_N10_M2_shadow10_episode1-5000_travel0_fd10_pfs',
                    # help='json file for the deployment')
# parser.add_argument('--json-file', type=str, default='train_K5_N20_M5_shadow10_episode1-5000_travel0_fd10_pfs',
#                     help='json file for the deployment')
parser.add_argument('--json-file-policy', type=str, default='dqn200_200_100',
...
# json_file = "train_K5_N10_M1_shadow10_episode1-25000_travel0_fd15"
